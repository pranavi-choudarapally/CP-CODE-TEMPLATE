...
**Purpose:** Frequently used bit manipulation operations.

| Function | Purpose |
|----------|---------|
| `decToBin(n)` | Convert decimal to binary string |
| `setBit(n,k)` | Set the k-th bit |
| `getBit(n,k)` | Get the value of the k-th bit (0 or 1) |
| `toggleBit(n,k)` | Toggle the k-th bit |
| `clearBit(n,k)` | Clear the k-th bit |
